...
DEBUG = False
SAVE_EXCEL = True
SAVE_INDUSTRIAL_MOMENTUM_SCORE = True
...
if NAME_STOCK_WORLD == "RUSSELL-3000":
    ...
    SCORE_FUNCTION = 'two_cat'               # 'five_group'   or 'two_cat'
    ...
    # GROUP1_FACTORS = ['priceToBookRatio','priceEarningsRatio','enterpriseValueOverEBITDA','returnOnEquity']
